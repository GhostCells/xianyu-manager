...
5. Add only `XIANYU_MANAGER_BROWSER_CDP_URL=http://127.0.0.1:9222` to manager configuration; retain existing account and capability settings. Start manager. Inspect listener binding inside the namespace and prove no outside exposure.
