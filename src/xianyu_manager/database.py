    ...
    def __init__(self, path: Path, *, safe_mode: bool = False, prepare_mode: bool = False, runtime_account_id: int | None = None):
        ...
        with self.connect() as connection:
            ...
            for table, name, declaration in (
                ...
                ("products", "delivery_kind", "TEXT NOT NULL DEFAULT 'zip'"),
                ("products", "delivery_revision", "TEXT NOT NULL DEFAULT ''"),
        ...
        with self.connect() as connection:
            rows = connection.execute(
                ...
                SELECT
                    ...
                    p.verified_fingerprint, p.share_verified_at, p.delivery_safety_fingerprint, p.delivery_kind, p.delivery_revision,
        ...
        with self.connect() as connection:
            rows = connection.execute(
                ...
                SELECT
                    ...
                    p.zip_name,p.zip_hash,p.zip_size,p.quality_errors_json,p.verified_fingerprint,p.delivery_safety_fingerprint,p.delivery_kind,p.delivery_revision,
